...
const tmpSurveys = [
  {
      "id": 1,
      "image_url": "https://static1.cbrimages.com/wordpress/wp-content/uploads/2021/10/pain-six-paths-from-naruto.jpg?q=50&fit=contain&w=1140&h=&dpr=1.5",
      "title": "  Doujutsu",
      "slug": " test",
      "status": true,
      "description": "My name is John.<br>I am Web Developer with 9+ years of experience, free educational content creator, CTO, Lecturer and father of two wonderful daughters.<br><br>The purpose of the channel is to share my several years of experience with beginner developers.<br>Teach them what I know and make my experience as a lesson for others.",
  ...
  {
      "id": 2,
      "image_url": "https://wallpapers.com/images/hd/pain-mangekyo-sharingan-awq9wv7f2mjpjnqq.jpg",
      "title": "Testing",
      "slug": "react",
      "status": true,
      "description": "Testing.",
  ...
  {
      "id": 3,
      "image_url": "//resizing.flixster.com/h_wYGhaBEJ0zvwWFn9GDh1Fijsg=/fit-in/705x460/v2/https://resizing.flixster.com/-XZAfHZM39UwaGJIFWKAE8fS0ak=/v3/t/assets/p21533478_b_h8_ai.jpg",
      "title": "Testing",
      "slug": "laravel-9",
      "status": true,
...
export const ContextProvider = ({children}) => {
    ...
    const [ tasks, setSurveys] = useState(tmpSurveys)
